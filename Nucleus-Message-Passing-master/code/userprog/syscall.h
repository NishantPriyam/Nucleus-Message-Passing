...
#define SC_SendMessage		43
#define SC_SendAnswer 		44
#define SC_WaitMessage 		45
#define SC_WaitAnswer 		46
...
void SendAnswer(int* result, char* answer, int bufferId);

void WaitAnswer(int* result, char* answer, int bufferId);

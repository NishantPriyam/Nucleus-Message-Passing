...
Thread::Thread(char* threadName)
{
    ...
    status = JUST_CREATED;
    string s(this->name);
    kernel->threadMap[s] = this;
    messageQueue = new List<Buffer>();
...
Thread::Begin ()
{
    ...
    //printf(" The size is %d",kernel->threadMap.size());
...
Thread::Finish ()
{
    ...
    cout << "Program '" << this->name  << "' is Terminating from Kernel\n";
    string s(this->name);
    kernel->threadMap.erase(s);
